...
```sh
make build-installer IMG=<some-registry>/saas-operator:tag
```
...
```sh
kubectl apply -f https://raw.githubusercontent.com/<org>/saas-operator/<tag or branch>/dist/install.yaml
```
