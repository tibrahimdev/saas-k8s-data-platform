...
certManager: {
	...
	properties: {
		...
		chart:           "cert-manager"
		targetNamespace: parameter.certManager.namespace
		version:         "v1.19.2"
		upgradeCRD:      parameter.certManager.upgradeCRD
		values: {
			installCRDs:  parameter.certManager.installCRDs
			replicaCount: parameter.certManager.replicas
